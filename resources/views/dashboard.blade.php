    ...
    <div class="overview grid grid-cols-4 gap-4 mt-5">
        ...
        <div class="col-span-1">
            <div class="grid grid-cols-1 gap-4 mb-3">
                <div class="col-span-1 bg-slate-200 p-4">
                    <h5 class="text-xs font-medium">To Do Lists</h5>
                    <hr class="mt-2">
                    <ul class="list mt-3">
                        <li class="flex items-center gap-3 mb-2">
                            ...
                            <h5 class="text-xs font-base text-gray-600 line-clamp-2">Upload Projects</h5>
                        </li>
                        <li class="flex items-center gap-3 mb-2">
                            <div class="p-1 bg-gray-400 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-800">
                            ...
                            <h5 class="text-xs font-base text-gray-600 line-clamp-2">Add social media links to this platform</h5>
                        </li>
                    </ul>
                </div>
            </div>
