            ...
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 lg:col-span-4">
                        ...
                        <x-input id="text" type="text" class="mt-1 block w-full text-slate-500" value="Super Administrator" disabled/>
                        <x-input-error for="role" class="mt-2" />
                    </div>
                    @else
                    <div class="col-span-6 lg:col-span-4">
                        <x-label for="role" value="{{ __('Role') }}" />
                        <x-input id="text" type="text" class="mt-1 block w-full text-slate-500" value="Administrator" disabled/>
                        <x-input-error for="role" class="mt-2" />
                    </div>
                    @endif
                </x-slot>
